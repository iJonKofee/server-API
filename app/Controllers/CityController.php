...
class CityController extends Core_Controller_Abstract
{

    public function manageAction()
    {
        $this->view->rows = City_Table::getInstance()->find();
    }
    ...
    public function addAction()
    {
        ...
        try 
        {
            $row = City_Manager::getInstance()->add($name);
        }
    ...
    public function editAction()
    {
        ...
        $row = City_Table::getInstance()->findFirst($id);
